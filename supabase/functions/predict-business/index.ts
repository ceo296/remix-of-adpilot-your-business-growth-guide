...
נחש את הפרטים הבאים והחזר בפורמט JSON:
{
  ...
  "phone": "מספר טלפון אם נמצא באתר או null",
  "email": "כתובת מייל אם נמצאה באתר או null",
  "address": "כתובת פיזית אם נמצאה באתר או null",
  "whatsapp": "מספר וואטסאפ אם נמצא באתר או null",
  "facebook": "קישור לפייסבוק אם נמצא באתר או null",
  "instagram": "שם משתמש או קישור לאינסטגרם אם נמצא באתר או null",
  "youtube": "קישור ליוטיוב אם נמצא באתר או null",
  "linkedin": "קישור ללינקדאין אם נמצא באתר או null",
  "tiktok": "שם משתמש או קישור לטיקטוק אם נמצא באתר או null"
}
...
הערה חשובה לגבי פרטי קשר: חלץ את כל פרטי הקשר שמופיעים בתוכן האתר. אם לא נמצא מידע - החזר null.`;
