...
8. 🛡️ פרוטוקול מקוריות (Originality Protocol):
   - למד מהרפרנסים את ה"איך" ולא את ה"מה": את המקצב (קצר/ארוך, שנון/תורני), את האווירה (יוקרה/חמימות/עוצמה), את אוצר המילים — אבל לעולם אל תעתיק מילה במילה.
   - פרוק והרכבה (Deconstruction): פרק כל רפרנס לגורמים ("ניגודיות צבעים חזקה", "שאלה רטורית בכותרת", "טוויסט על ביטוי תלמודי") — ואז הרכב מחדש בצורה מקורית.
