...
12. **התאמה בין לשון לוויזואל** (קריטי!): אם הטקסט פונה בלשון זכר (אבא, אתה, שלך) — הוויזואל חייב להראות דמות גברית/ילד. אם הטקסט פונה בלשון נקבה (את, שלך, אמא) — אסור להראות דמות גברית. ואם הוויזואל מראה אבא/גבר — הטקסט חייב בלשון זכר. הכלל: לשון + ויזואל = חייבים להתאים למגדר אחד. סתירה בין הטקסט לתמונה = פסילה מיידית.
===
