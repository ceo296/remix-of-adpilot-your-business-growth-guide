...
1. ניואנסים ויזואליים מגזריים:
- כל עיצוב חייב לשדר "אותנטיות חרדית" – לא גנרי, לא סטרילי
- השתמש בקודים ויזואליים מוכרים: שטריימל ובעקיצע לחסידי, חליפה שחורה וכובע לליטאי, כיפה סרוגה/רקומה לספרדי
- רקעים אותנטיים: בית מדרש, רחוב מאה שערים, שוק מחנה יהודה, כותל, ציון קבר צדיק
- אביזרים מגזריים: גמרא, סידור, חנוכייה, לולב ואתרוג, מצות שמורה, הדס
- טקסטורות: פרגמנט עתיק, גוויל, קלף תורה, אריחי ירושלמי

2. טיפוגרפיה מגזרית:
- כותרות: פונט "תורני" עבה עם סריפים (סגנון רש"י, סגנון דפוס וילנא) למותגים מסורתיים
- כותרות מודרניות: סנס-סריף עברי נקי עם משקל Bold/Black
- אסור: פונטים לטיניים בלבד, פונטים "חילוניים" מדי
- הטקסט העברי תמיד RTL, תמיד מיושר לימין

3. פלטת צבעים מגזרית:
- חסידי/יוקרתי: זהב (#C5A03F), בורדו (#8B1A1A), שחור עמוק, לבן קרם
- ליטאי/מקצועי: כחול כהה (#1B3A5C), אפור פחם, לבן נקי
- ספרדי/חם: תכלת (#0077B6), ירוק אמרלד (#006B3C), חום חמים
- כללי/מודרני: גרדיאנט עדין, פסטלים חמים, ניגודיות גבוהה

4. איסור קלישאות ויזואליות:
- אסור: תמונות סטוק גנריות, חיוכים מלאכותיים, עיצוב "אמריקאי"
- אסור: אלמנטים שלא שייכים לעולם החרדי (כלב, חוף ים מעורב)
- חובה: כל אלמנט ויזואלי חייב להיות "מדויק מגזרית"
...
- נתח את הסגנון הוויזואלי: קומפוזיציה, צבעוניות, טיפוגרפיה
- חקה את "האווירה" של הרפרנס המוצלח, לא העתקה ישירה
- ציין במפורש: "בהשראת [שם הרפרנס]" כשרלוונטי
- אם הרפרנס חסידי – שמור על קוד ויזואלי חסידי, וכן הלאה
...
- תיאור הסצנה המדויק עם ניואנסים מגזריים ספציפיים (לבוש, רקע, אביזרים)
- זווית צילום ותאורה (למשל: "warm golden hour light through a yeshiva window")
- לבוש חרדי מדויק לפי הזרם (שטריימל+בעקיצע לחסידי, כובע+חליפה לליטאי)
- צבעי המותג והפונטים
- אלמנטים חגיים ספציפיים אם רלוונטי (סדר table, menorah, sukkah)
- מה לא לכלול (נשים, טכנולוגיה לא מסוננת, אלמנטים לא מגזריים)
