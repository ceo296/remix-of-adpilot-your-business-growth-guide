...
- **התאמה מגדרית בין לשון לוויזואל**: אם הקופי פונה בלשון זכר — הוויזואל חייב להיות גברי/ילד. אם בלשון נקבה — אסור דמות גברית. סתירה = פסילה מיידית.
...
1. **כותרת (Headline)**: הטקסט הכי גדול ודומיננטי. ממוקם בראש המודעה או במרכז-עליון. פי 2-3 מגודל הבאדי. מילים מעטות, אימפקט מקסימלי.
