...
- 🛡️ פרוטוקול מקוריות: למד את ה"איך" ולא את ה"מה":
  • אל תעתיק את הקומפוזיציה כמו שהיא — תלמד את העיקרון (למשל: "ניגודיות חזקה בין כותרת לרקע", "שימוש בחלל שלילי").
  • אל תעתיק את הוויזואל כמו שהוא — תלמד את האווירה (יוקרה, חמימות ביתית, עוצמה חסידית).
