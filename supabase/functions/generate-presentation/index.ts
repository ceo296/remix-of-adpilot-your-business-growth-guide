...
serve(async (req) => {
  ...
  try {
    ...
    try {
      ...
      if (parts.length) sectorContext = `\n\n🧠 רפרנסים סקטוריאליים:\n${parts.join('\n\n')}\n\n🛡️ פרוטוקול מקוריות: השתמש ברפרנסים כבסיס להבנת ה-DNA הסגנוני בלבד. למד את ה"איך" (מבנה שקופיות, טון, אווירה) — אך אל תעתיק תוכן או מבנה כמו שהוא. פרק כל דוגמה לגורמים והרכב מחדש בצורה מקורית.`;
