...
if (parts.length > 0) {
        sectorContext = `\n\n🧠 מידע סקטוריאלי — חרדי (חובה להיצמד לסגנון, לטון ולכללים הבאים):\n${parts.join('\n\n')}\n\n🛡️ פרוטוקול מקוריות: השתמש ברפרנסים כבסיס להבנת הסגנון בלבד. למד את אוצר המילים, הטון והמקצב — אך אל תעתיק משפטים או מבנים. פרק כל דוגמה לגורמים והרכב מחדש בצורה מקורית.`;
      }
    }
