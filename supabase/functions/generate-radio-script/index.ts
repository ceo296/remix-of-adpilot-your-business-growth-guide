...
צור 2 גרסאות מתוקנות בהתאם לבקשה. שמור על כל מה שלא ביקש לשנות.`;
    ...
    try {
      ...
      if (parts.length) sectorContext = `\n\n🧠 רפרנסים סקטוריאליים:\n${parts.join('\n\n')}\n\n🛡️ פרוטוקול מקוריות:\n- למד מהדוגמאות הכל: מילים, ביטויים, קצב, מבנה דרמטי, טון, אווירה.\n- ספוג את השפה הסקטוריאלית — כך מדברים בעולם הזה.\n- אבל: אסור בהחלט להעתיק משפט, קטע, או מבנה תסריט אחד-לאחד.\n- פרק לגורמים ("פתיחה דרמטית", "טוויסט באמצע", "הוק בסיום") → הרכב מחדש בצורה מקורית.\n- המטרה: תסריט שמרגיש כמו משרד פרסום חרדי ותיק — אבל חדש לגמרי.`;
